...
```bash
git clone https://github.com/BravoRicDev/agent-first-simple-newsletter-cms.git
cd gestione-siti-riccardom
...
See [UPGRADE-INSTRUCTIONS.md](../UPGRADE-INSTRUCTIONS.md) for detailed steps on upgrading a production installation.
