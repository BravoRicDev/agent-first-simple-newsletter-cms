-- 106: Sync bidirezionale con il CRM sorgente — configurazione.
--
-- Estende source_sync_config con i flag del PUSH (CMS → sorgente), opzionale per
-- sito e disattivato di default:
--   push_enabled   : accoda e spedisce le mutate del CMS verso sorgente
