-- 130: raw del contatto sorgente, per parità di shape su POST /contacts/search.
--
...
-- custom field). Per rendere la risposta del clone-API IDENTICA a sorgente SENZA nuove
...
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS source_contact_raw JSONB;
