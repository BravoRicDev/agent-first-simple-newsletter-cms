...
-- LIMIT 1). Con due siti sullo stesso account sorgente e conteggi UGUALI (site 21 e
-- site 22, entrambi 14592) la scelta era arbitraria e SIMMETRICA: entrambi
-- potevano decidere di clonare dall'altro ⇒ NESSUNO chamava più sorgente per i
...
--     tornano master/standalone (chiamano sorgente da soli) invece di rompersi.
...
-- Seed ambiente attuale: site 21 = MASTER (sync_master_site_id resta NULL);
-- site 22 = SLAVE di 21.
