...
//
// Tool PROGETTATO per l'import dei dati v1 ("API compatibili con CRM diffusi")
// e ora IMPLEMENTATO. Carica un file JSON con la struttura documentata e
// popola le tabelle v1 (F0 + ONDA 1) in modo IDEMPOTENTE (ON CONFLICT /
// upsert): può essere rieseguito senza duplicare dati.
//
